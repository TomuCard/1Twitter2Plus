...
window.onload = function () {
  document.getElementById("send-to-korg").onsubmit = function (event) {
    ...
    var userInput = document.getElementById("input-prompt").value.trim();
...
function callIA(_x) {
  return _callIA.apply(this, arguments);
}
function _callIA() {
  _callIA = _asyncToGenerator(/*#__PURE__*/_regeneratorRuntime().mark(function _callee(prompt) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 4:
          ...
          throw new Error("Erreur ! Statut : ".concat(response.status));
        case 7:
          _context.next = 9;
        ...
        case 15:
          ...
          displayResponse("Erreur : " + _context.t0.message);
        case 18:
        case "end":
...
function displayResponse(message) {
  var container = document.getElementById("container-korg");
